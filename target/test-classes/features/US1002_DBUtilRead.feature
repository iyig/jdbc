Feature: US1002 kullanici DBUtill ile database'e baglanip istedipi field bilgilerini okur

  Scenario: TC02 kullanici tablo ve field ismi ile sorgu yapbilmel
